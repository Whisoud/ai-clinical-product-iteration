...
window.navConfig = [
  ...
  },
  {
    ...
    "children": [
      {
        "id": "page-knowledge-qa",
        "name": "知识问答页面 V1.0.1",
        "url": "./pages/Knowledge_Q&A.html",
        "type": "page"
      },
      {
        "id": "page-knowledge-qa-v102",
        "name": "知识问答页面 V1.0.2",
        "url": "./pages/Knowledge_Q&A_V1.0.2.html",
        "type": "page"
      }
    ]
  }
...
window.PrdStore["prd-mr398qtu-m6hod"] = {
  title: "输出内容",
  desc: "**数据与界面交互**\n\n- 流式输出\n\n- 文献标识：鼠标移入后在文字上方展示文献弹窗（动态大小），移出消失\n内容包含文献标题（注意书名号、不要.md 后缀）、文献片段、核心内容加粗",
  pageUrl: "./pages/Knowledge_Q&A.html"
};

window.PrdStore["prd-mr39iw5c-7s36r"] = {
  title: "参考文献",
  desc: "**数据来源**\n\n- 展示上文中所有提到的文献并去重展示\n- 注意书名号，不要.md 后缀\n- 显示全部，不要省略，显示不下就折行\n\n**交互**\n\n- 点击后右侧弹出文献正文",
  pageUrl: "./pages/Knowledge_Q&A.html"
};
...
window.PrdStore["prd-msn90k2x-4qj7w"] = {
  title: "新建对话按钮",
  desc: "**交互**\n\n- 点击后中断当前输出：若当前会话已有内容，自动归档至历史会话「今天」分组顶部\n- 主区回到欢迎视图，会话栏标题复位为「新对话」\n- 当前已是新对话时点击，Toast 轻提示「当前已是新对话」",
  pageUrl: "./pages/Knowledge_Q&A.html"
};

window.PrdStore["prd-msn90m4t-8z3pd"] = {
  title: "历史会话入口",
  desc: "**交互**\n\n- 点击后历史会话面板从窗口右侧外弹，与文献详情抽屉互斥（同开时文献抽屉关闭）\n- 再次点击按钮 / 点击遮罩 / 点击面板右上角 X 均可收起面板",
  pageUrl: "./pages/Knowledge_Q&A.html"
};

window.PrdStore["prd-msn90r6y-2v9hd"] = {
  title: "历史会话面板",
...
// ===== 以下为知识问答 V1.0.2 页面标注（pages/Knowledge_Q&A_V1.0.2.html） =====
